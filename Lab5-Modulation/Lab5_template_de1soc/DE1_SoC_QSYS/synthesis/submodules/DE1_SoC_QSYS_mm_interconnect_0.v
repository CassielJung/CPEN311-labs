...
// 
// Generated using ACDS version 14.1 186 at 2021.11.25.09:20:43
...
module DE1_SoC_QSYS_mm_interconnect_0 (
	...
	wire          cmd_mux_019_src_valid;                                                     // cmd_mux_019:src_valid -> lfsr_val_s1_agent:cp_valid
	wire  [116:0] cmd_mux_019_src_data;                                                      // cmd_mux_019:src_data -> lfsr_val_s1_agent:cp_data
	wire          cmd_mux_019_src_ready;                                                     // lfsr_val_s1_agent:cp_ready -> cmd_mux_019:src_ready
	wire   [24:0] cmd_mux_019_src_channel;                                                   // cmd_mux_019:src_channel -> lfsr_val_s1_agent:cp_channel
	wire          cmd_mux_019_src_startofpacket;                                             // cmd_mux_019:src_startofpacket -> lfsr_val_s1_agent:cp_startofpacket
	wire          cmd_mux_019_src_endofpacket;                                               // cmd_mux_019:src_endofpacket -> lfsr_val_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_020_src_valid;                                                     // cmd_mux_020:src_valid -> dds_increment_s1_agent:cp_valid
	wire  [116:0] cmd_mux_020_src_data;                                                      // cmd_mux_020:src_data -> dds_increment_s1_agent:cp_data
	wire          cmd_mux_020_src_ready;                                                     // dds_increment_s1_agent:cp_ready -> cmd_mux_020:src_ready
	wire   [24:0] cmd_mux_020_src_channel;                                                   // cmd_mux_020:src_channel -> dds_increment_s1_agent:cp_channel
	wire          cmd_mux_020_src_startofpacket;                                             // cmd_mux_020:src_startofpacket -> dds_increment_s1_agent:cp_startofpacket
	wire          cmd_mux_020_src_endofpacket;                                               // cmd_mux_020:src_endofpacket -> dds_increment_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_021_src_valid;                                                     // cmd_mux_021:src_valid -> lfsr_clk_interrupt_gen_s1_agent:cp_valid
	wire  [116:0] cmd_mux_021_src_data;                                                      // cmd_mux_021:src_data -> lfsr_clk_interrupt_gen_s1_agent:cp_data
	wire          cmd_mux_021_src_ready;                                                     // lfsr_clk_interrupt_gen_s1_agent:cp_ready -> cmd_mux_021:src_ready
	wire   [24:0] cmd_mux_021_src_channel;                                                   // cmd_mux_021:src_channel -> lfsr_clk_interrupt_gen_s1_agent:cp_channel
	wire          cmd_mux_021_src_startofpacket;                                             // cmd_mux_021:src_startofpacket -> lfsr_clk_interrupt_gen_s1_agent:cp_startofpacket
	wire          cmd_mux_021_src_endofpacket;                                               // cmd_mux_021:src_endofpacket -> lfsr_clk_interrupt_gen_s1_agent:cp_endofpacket
	...
	wire          lfsr_val_s1_agent_rp_valid;                                                // lfsr_val_s1_agent:rp_valid -> router_022:sink_valid
	wire  [116:0] lfsr_val_s1_agent_rp_data;                                                 // lfsr_val_s1_agent:rp_data -> router_022:sink_data
	wire          lfsr_val_s1_agent_rp_ready;                                                // router_022:sink_ready -> lfsr_val_s1_agent:rp_ready
	wire          lfsr_val_s1_agent_rp_startofpacket;                                        // lfsr_val_s1_agent:rp_startofpacket -> router_022:sink_startofpacket
	wire          lfsr_val_s1_agent_rp_endofpacket;                                          // lfsr_val_s1_agent:rp_endofpacket -> router_022:sink_endofpacket
	...
	wire          dds_increment_s1_agent_rp_valid;                                           // dds_increment_s1_agent:rp_valid -> router_023:sink_valid
	wire  [116:0] dds_increment_s1_agent_rp_data;                                            // dds_increment_s1_agent:rp_data -> router_023:sink_data
	wire          dds_increment_s1_agent_rp_ready;                                           // router_023:sink_ready -> dds_increment_s1_agent:rp_ready
	wire          dds_increment_s1_agent_rp_startofpacket;                                   // dds_increment_s1_agent:rp_startofpacket -> router_023:sink_startofpacket
	wire          dds_increment_s1_agent_rp_endofpacket;                                     // dds_increment_s1_agent:rp_endofpacket -> router_023:sink_endofpacket
	...
	wire          lfsr_clk_interrupt_gen_s1_agent_rp_valid;                                  // lfsr_clk_interrupt_gen_s1_agent:rp_valid -> router_024:sink_valid
	wire  [116:0] lfsr_clk_interrupt_gen_s1_agent_rp_data;                                   // lfsr_clk_interrupt_gen_s1_agent:rp_data -> router_024:sink_data
	wire          lfsr_clk_interrupt_gen_s1_agent_rp_ready;                                  // router_024:sink_ready -> lfsr_clk_interrupt_gen_s1_agent:rp_ready
	wire          lfsr_clk_interrupt_gen_s1_agent_rp_startofpacket;                          // lfsr_clk_interrupt_gen_s1_agent:rp_startofpacket -> router_024:sink_startofpacket
	wire          lfsr_clk_interrupt_gen_s1_agent_rp_endofpacket;                            // lfsr_clk_interrupt_gen_s1_agent:rp_endofpacket -> router_024:sink_endofpacket
